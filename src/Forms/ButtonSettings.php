...
class ButtonSettings extends Form {
    ...
    public function __construct($name, $data) {
        ...
        $this->children([
            ...
            Colour::make($name . '[i][color]', 'Text Colour')
            ->manualInit(true),
            
            Colour::make($name . '[i][background_color]', 'Background Colour')
            ->manualInit(true),
           
            Colour::make($name . '[i][border_color]', 'Border Colour')
            ->manualInit(true),
